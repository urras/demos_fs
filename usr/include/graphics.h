...
#define LEFT_TEXT 0     /* координата слева от текста */
#define CENTER_TEXT 1   /* координата в середине текста */
#define RIGHT_TEXT 2    /* координата справа от текста */

	/* вертикальное выравнивание */

#define BOTTOM_TEXT 0   /* координата снизу от текста */
/*  #define CENTER_TEXT 1 - определено выше */
#define TOP_TEXT 2      /* координата сверху от текста */
